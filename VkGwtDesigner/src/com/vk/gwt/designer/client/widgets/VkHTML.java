...
public class VkHTML extends HTML implements IVkWidget, HasVkText, HasVkHtml, HasVkAllMouseHandlers, HasVkWordWrap, HasVkHorizontalAlignment, HasVkDirection{
	final public static String NAME = "HTML";
