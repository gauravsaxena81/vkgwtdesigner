...
public class VkInlineHTML extends InlineHTML implements IVkWidget, HasVkText, HasVkHtml, HasVkAllMouseHandlers, HasVkWordWrap, HasVkHorizontalAlignment, HasVkDirection{
	final public static String NAME = "Inline HTML";
