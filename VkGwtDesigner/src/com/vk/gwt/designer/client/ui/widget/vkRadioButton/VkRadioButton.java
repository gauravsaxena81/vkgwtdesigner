...
public class VkRadioButton extends RadioButton implements IVkWidget, HasVkText, HasVkAllKeyHandlers, HasVkAllMouseHandlers, HasVkFocusHandler
, HasVkBlurHandler, HasVkAccessKey, HasVkTabIndex, HasVkEnabled, HasVkName, HasVkValue<Boolean>{

	public VkRadioButton() {
		super("");
	}
