...
public class VkMenu extends MenuBar implements HasBlurHandlers{
	...
	protected Command showStyleDialog(final Widget invokingWidget) {
		return new Command(){
			...
			private void addChangeListenerToWidget(final String attribute, final TextBox paddingTextBox) {
					...
					public void execute() {
						...
						ok.addClickHandler(new ClickHandler() {
							...
							public void onClick(ClickEvent event) {
								...
								VkDesignerUtil.executeEvent(VkDesignerUtil.getDrawingPanel().getPriorJs(HasVkLoadHandler.NAME), (Map<String, String>)null);
								loadDialog.hide();
							}
						});
