 ...
 * the License.
 */
package com.vk.gwt.designer.client.ui.widget.colorpicker;
 ...
 * Color picker 
 */
public class VkColorPicker extends PopupPanel implements ClickHandler, HasValueChangeHandlers<VkColorPicker>  {
    ...
    ValueChangeHandler<VkColorPicker> changeHandler = null;
    ...
    public HandlerRegistration addValueChangeHandler(ValueChangeHandler<VkColorPicker> handler) {
    ...
    public void onClick(ClickEvent event) {
        ...
        if (changeHandler != null)
            changeHandler.onValueChange(new ValueChangeEvent<VkColorPicker>(this){});
    }
