...
public class VkDesignerUtil {
	...
	public static void loadApplication(String text) {
		VkStateHelper.getInstance().getWidgetEngineMapping().getEngineMap().get(VkMainDrawingPanel.NAME).deserialize((IVkWidget) VkMainDrawingPanel.getInstance(), text);
		VkStateHelper.getInstance().getEventHelper().executeEvent(VkMainDrawingPanel.getInstance().getPriorJs(HasVkLoadHandler.NAME), (Map<String, String>)null);
	...
	public static void fillParent(final Widget widget) {
		Widget parent = widget.getParent();
		final int originalWidth = widget.getOffsetWidth();
		final int originalHeight = widget.getOffsetHeight();
		final int parentWidth = parent.getOffsetWidth();
		final int parentHeight = parent.getOffsetHeight();
		final int widgetDecorationWidth = (int)getDecorationsWidth(widget.getElement());
		final int widgetDecorationHeight = (int)getDecorationsHeight(widget.getElement());
		final int parentDecorationWidth = (int)getDecorationsWidth(parent.getElement());
		final int parentDecorationHeight = (int)getDecorationsHeight(parent.getElement());
